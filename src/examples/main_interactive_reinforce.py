...
from interactive_algorithms import DemonstrationReinforceAlgorithm
...
if __name__ == "__main__":
    ...
    parser.add_argument('-risk_eps', '--r', help='Risk Epsilon', dest="risk_eps", default=0.01)
    ...
    model = DemonstrationReinforceAlgorithm(env_class=BatchSymbolicRegressionEnv,
                                           env_kwargs=env_kwargs,
                                           policy_class=Policy,
                                           policy_kwargs=policy_kwargs,
                                           dataset=dataset,
